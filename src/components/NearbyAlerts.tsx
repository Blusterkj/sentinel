        ...
        {displayAlerts.map((alert, idx) => {
          ...
          return (
            <motion.div
              ...
              className="bg-white/10 backdrop-blur-xl border border-white/20 py-10 px-4 rounded-xl shadow-2xl relative overflow-hidden group cursor-pointer hover:bg-white/15 transition-colors"
            >
              ...
              <div className="flex justify-between items-start mb-2">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="text-white/40 hover:text-white/90 transition-colors mr-6"
                  >
                    <X size={14} />
                  </button>
                </div>
